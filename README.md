...
For the simulation video, the duration of 5 seconds (real-time) was extended to 12 seconds, with interpolation to 240 FPS using FlowFrames and upscaling to 4K resolution using Video2X.
